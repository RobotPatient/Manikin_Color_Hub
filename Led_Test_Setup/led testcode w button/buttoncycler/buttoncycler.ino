    ...
    if(newState == LOW) {      // Yes, still low
      ...
      switch(mode) {           // Start the new animation...
        case 0:
          ...
          break;
        case 1:
          colorWipe(strip.Color(colorVal,   0,   0), 50);    // Red
          break;
        case 2:
          colorWipe(strip.Color(  0, colorVal,   0), 50);    // Green
          break;
        case 3:
          colorWipe(strip.Color(  0,   0, colorVal), 50);    // Blue
          break;
        case 4:
          colorWipe(strip.Color(  (colorVal/3), (colorVal/3), (colorVal/3)), 50);    // White
