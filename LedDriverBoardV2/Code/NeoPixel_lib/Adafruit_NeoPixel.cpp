...
#include <cstdlib>
#include "sam.h"
#include  <lib/Universal_hal/hal/hal_gpio.h>
#include <cstring>
#include <cctype>
#include "Adafruit_NeoPixel.h"

// free, memset
// check pinMask and portNum
...
*/
Adafruit_NeoPixel::Adafruit_NeoPixel(uint16_t n, int16_t p, neoPixelType t) : begun(false), brightness(0), pixels(NULL), endTime(0)
{
    updateType(t);
    updateLength(n);
    setPin(p);
...
//#if defined(__SAMD21E17A__) || defined(__SAMD21G18A__) || \
...
//      defined (__SAMD11C14A__)
    ...
    portNum = gpio_get_pin_options(pin);
    pinMask = 1ul << 10;
    ptr = pixels;
    end = ptr + numBytes;
    p = *ptr++;
...
*/
void Adafruit_NeoPixel::rainbow(uint16_t first_hue, int8_t reps, uint8_t saturation, uint8_t brightness, bool gammify)
{
